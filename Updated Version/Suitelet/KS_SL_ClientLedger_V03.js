            ...
            function getRecordQuery(customer) {
                try {
                   ...
                   SELECT
                        ...
                        COALESCE(BUILTIN.DF(tl.custcol_exp_cat), '') AS expcategory,
                    ...
                    (
                        (
                            ...
                            AND t.type NOT IN ('CustPymt','VendPymt','Transfer')
                        )
                        OR
                        (
                            t.type = 'Transfer'
                    ...
                    (
                        (
                            ...
                            AND a.accttype NOT IN ('AcctRec','AcctPay','OthCurrLiab','CredCard')
                        )
                        OR
                        (
        ...
        require(['N/currentRecord'], function () {
            ...
            function getExportRecords(customerText, listOfRecords, context) {
                ...
                listOfRecords.forEach(function (row) {
                    ...
                    if (isTrust) {
                        if (!trustAccountSummary[accountName]) {
                            trustAccountSummary[accountName] = { debit: 0, credit: 0, accountText: accountName };
                        }
                ...
                csv.push(csvRow([
                    'Date', 'Payee', 'Memo', 'Client', 'Document Number',
                    'Account', 'General Amount', 'Trust Amount'
                ]));
